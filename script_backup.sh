...
Help() {
  ...
  echo "  -o    Output directory with or without name. Defaults to '/home/ampradana/backup_odoo'"
  echo "  -h    Odoo host. Defaults to 'http://localhost:8080'"
...
: ${PASSWORD:=${ODOO_MASTER_PASSWORD:='admin1234'}}
: ${OUTPUT:='/home/ampradana/backup_odoo'}
: ${ODOO_HOST:='http://localhost:8080'}
